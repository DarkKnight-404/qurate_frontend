...
function Header() {
    return (
        <div style={{ padding: '3px', backgroundColor: '#f0f0f0', borderBottom: '1px solid #ccc', display: "flex" }}>
            <div className='header_logo' style={{ alignContent: "center", alignItems: "center", display: "flex", justifyContent: "center", marginRight: "10px" }}>
                ...
                <h2 style={{ margin: "0px", paddingLeft: "10px", color: "black", fontSize: "20px" , fontWeight: "bold" }}>
                    Prometheus
                </h2>

            </div>
            <div style={{ float: "right", marginLeft: "auto", marginRight: "10px", display: "flex", alignItems: "center", justifyContent: "center", gap: "18px" }}>
                <div>
